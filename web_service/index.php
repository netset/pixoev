...
<tr><td>Unique UserName :</td><td><input type="text" name="uniqueusername" ></input></td><td>uniqueusername</td></tr>
...
<h2>(20)<span style="color:blue">Delete reported pixo</span>(<span style="color:orange">deleteReportedPixo</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
service_type="<span style="color:red">deleteReportedPixo</span>"<br/>
<input type="hidden" name="service_type" value="deleteReportedPixo">
<table>
<tr><td>**User Id :</td><td><input type="text" name="user_id" ></input></td><td> user_id</td></tr>
<tr><td>**Event Id :</td><td><input type="text" name="event_id" ></input></td><td>   event_id</td></tr>
<tr><td>**Reported Image id:</td><td><input type="text" name="reportedpic_id" ></input></td><td>reportedpic_id</td></tr>
<tr><td><input type="submit" ></input></td></tr>
</table>
</form>
                            
                    
<h2>(21)<span style="color:blue">Delete all reported pixos</span>(<span style="color:orange">deleteAllReportedPixo</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
service_type="<span style="color:red">deleteAllReportedPixo</span>"<br/>
<input type="hidden" name="service_type" value="deleteAllReportedPixo">
<table>
<tr><td>**User Id :</td><td><input type="text" name="user_id" ></input></td><td> user_id</td></tr>
<tr><td>**Event Id :</td><td><input type="text" name="event_id" ></input></td><td>   event_id</td></tr>
<tr><td><input type="submit" ></input></td></tr>
...
<h2>(22)<span style="color:blue">Delete Image</span>(<span style="color:orange">deleteImg</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2>(23)<span style="color:blue">Download Image</span>(<span style="color:orange">dwmloadImg</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2>(24)<span style="color:blue">Report Image</span>(<span style="color:orange">reportImg</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2>(25)<span style="color:blue">List all Report Images</span>(<span style="color:orange">allreportImg</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2>(26)<span style="color:blue">Delete Friend</span>(<span style="color:orange">deleteFriend</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2>(27)<span style="color:blue">Edit Profile Picture</span>(<span style="color:orange">editProfilePic</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<tr><td>**User Name :</td><td><input type="text" name="user_name" ></input></td><td> user_name</td></tr>
<tr><td><input type="submit" ></input></td></tr>
</table>
</form>

<h2>(28)<span style="color:blue">Block user</span>(<span style="color:orange">blockUser</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<tr><td>**User Id :</td><td><input type="text" name="user_id" ></input></td><td> user_id</td></tr>
<tr><td>**Friend Id :</td><td><input type="text" name="friend_id" ></input></td><td> friend_id</td></tr>
<!-- <tr><td>**Block  :</td><td><input type="text" name="option" ></input></td><td> option(block=1, unblock=0)</td></tr> -->
<tr><td><input type="submit" ></input></td></tr>
</table>
</form>
...
<h2>(29)<span style="color:blue">Delete User</span>(<span style="color:orange">deleteUser</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2>(30)<span style="color:blue">Delete Event from User-FEED list</span>(<span style="color:orange">deleteUserfrmfeed</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2>(31)<span style="color:blue">SignUp & Login with Facebook</span>(<span style="color:orange">regThroughFb</span>)</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data">
service_type="<span style="color:red">regThroughFb</span>"<br/>
<input type="hidden" name="service_type" value="regThroughFb">
<table>
<tr><td>**Facebook Response Array:</td><td><input type="text" name="fbdata" ></input></td><td> fbdata</td></tr>
<tr><td><input type="submit" ></input></td></tr>
</table></form> 
...
<h2><span style="color:blue">Create Group</span>(<span style="color:orange">create_group</span>(<span style="color:grey">currently not in use</span>))</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2><span style="color:blue">Edit Group</span>(<span style="color:orange">editgroup</span>(<span style="color:grey">currently not in use</span>))</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2><span style="color:blue">List of All Groups</span>(<span style="color:orange">group_list</span>(<span style="color:grey">currently not in use</span>))</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
...
<h2><span style="color:blue">Group Detail</span>(<span style="color:orange">group_detail</span>(<span style="color:grey">currently not in use</span>))</h2>
...
<h2><span style="color:blue">Delete Group</span>(<span style="color:orange">deleteGroup</span>(<span style="color:grey">currently not in use</span>))</h2>
<form action="web_service.php" method="post" enctype="multipart/form-data" >
service_type="<span style="color:red">deleteGroup</span>"<br/>
<input type="hidden" name="service_type" value="deleteGroup">
<table>
<tr><td>**User Id :</td><td><input type="text" name="user_id" ></input></td><td> user_id</td></tr>
<tr><td>**Group Id :</td><td><input type="text" name="group_id" ></input></td><td> group_id</td></tr>
<tr><td><input type="submit" ></input></td></tr>
...
<h2><span style="color:blue">Verify Facebook Id</span></h2>
<form action="web_service.php" method="post" >service_type="<span style="color:red">facebook_verify_id</span>"<br/>
<input type="hidden" name="service_type" value="facebook_verify_id">
<table>
<tr><td>**Fb Id :</td><td><input type="text" name="fb_id" ></input></td><td>fb_id</td></tr>
<tr><td><input type="submit" ></input></td></tr>
</table></form>
